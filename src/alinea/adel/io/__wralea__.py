...
io_select_adel_geometric_data = Factory(name='select_adel_geometric_data',
                ...
                inputs=[{'interface': IStr, 'name': 'package', 'value': 'alinea.adel.data', 'desc': ''}, {'interface': IStr, 'name': 'laminaCur_pattern', 'value': '*laminaCur*.RData', 'desc': ''}, {'interface': IStr, 'name': 'lamina2D_pattern', 'value': '*lamina2D*.RData', 'desc': ''}, {'interface': IStr, 'name': 'laminaCur_filename', 'value': None, 'desc': ''}, {'interface': IStr, 'name': 'lamina2D_filename', 'value': None, 'desc': ''}],
...
io_select_adel_botanic_data = Factory(name='select_adel_botanic_data',
                ...
                nodemodule='alinea.adel.io.io',
                nodeclass='select_multiple_files',
                inputs=[{'interface': IStr, 'name': 'package', 'value': 'alinea.adel.data', 'desc': ''}, 
